    ...
    <div className='prompt_card'>
      ...
      {session?.user.id === post.creator._id && pathName === "/profile" && (
        <div className='mt-5 flex-center gap-4 border-t border-gray-100 pt-3'>
          <p
            className='font-inter text-sm blue_gradient cursor-pointer rounded-full border border-gray-100 py-1.5 px-5'
            onClick={handleEdit}
          >
            Edit
          </p>
          <p
            className='font-inter text-sm orange_gradient cursor-pointer rounded-full border border-gray-100 py-1.5 px-5'
